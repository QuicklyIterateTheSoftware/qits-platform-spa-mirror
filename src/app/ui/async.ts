 ...
 * error is drawn where the table would be, and the heading and the lede stay where they are.
 *
...
export class Async {
  /** The panel's own state. Ready draws nothing here. */
  ...
  /** What failed, in the caller's words: “Could not load the cached repositories”. */
